...
@section('content')
    ...
    <div class="section-full content-inner">
        <!-- Product -->
        <div class="container">
            <form class="shop-form" method="post" enctype="multipart/form-data" action="{{ route('updateArticle') }}">
                @csrf
                <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6 col-md-6 col-sm-6">
                                ...
                                <select class="form-control" id="marca" name="marca">
                                    ...
                                    @foreach($brands as $b)
                                        <option
                                            value="{{ $b['id'] }}" {{ old('id_marca') == $b['id'] || $article['id_marca'] == $b['id']  ? 'selected' : '' }}>{{ $b['nombre'] }}</option>
                                    @endforeach
                                </select>
                                @if($errors->has('marca'))
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-6">
                                ...
                                <select class="form-control" id="id_categoria" name="id_categoria">
                                    @foreach($categories as $category)
                                        <option
                                            value="{{ $category['id'] }}" {{ old('id_categoria') == $category['id'] || $article['id_categoria'] == $category['id'] ? "selected":"" }}>{{ trans('messages.' . $category['nombre']) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-6 col-md-6 col-sm-6">
                                ...
                                <input type="text" class="form-control"
                                       ...
                                       value="{{ old('nombre') ? old('nombre') : $article['nombre'] }}" name="nombre">
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-6">
                                ...
                                <textarea class="form-control"
                                          ...
                                          name="descripcion">{{ old('descripcion') ? old('descripcion') : $article['descripcion'] }}</textarea>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6 col-md-6 col-sm-6">
                                ...
                                <input type="text" maxlength="9" class="form-control"
                                       ...
                                       value="{{ old('precio') ? old('precio') : $article['precio'] }}" name="precio"
                                       id="precio">
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-6">
                                ...
                                <input type="text" class="form-control"
                                       ...
                                       value="{{ old('stock') ? old('stock') : $article['stock'] }}" name="stock">
                                @if($errors->has('stock'))
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6 col-md-6 col-sm-6">
                                ...
                                <select class="form-control" id="visible" name="visible">
                                    @if(old('visible') != null)
                                        <option
                                            value="1" {{  (old('visible') == 1) ? 'selected' : '' }}>{{ trans('messages.yes') }}</option>
                                        <option
                                            value="0" {{   (old('visible') == 0)  ? 'selected' : '' }}>{{ trans('messages.no') }}</option>
                                    @else
                                        <option
                                            value="1" {{  ($article['visible'] == 1)  ? 'selected' : '' }}>{{ trans('messages.yes') }}</option>
                                        <option
                                            value="0" {{  ($article['visible'] == 0)  ? 'selected' : '' }}>{{ trans('messages.no') }}</option>
                                    @endif
                                </select>
                        ...
                        <div class="row">
                            <div class="form-group">
                                <button class="site-button button-lg btn-block ml-4"
                                        type="submit">{{ trans('messages.updateArticle') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            if (selectedBrand != "selectBrand") {
                ...
                if (oldModel == "") {
                    oldModel = "{{ $article['id_modelo'] }}";
                }

                if (oldEngine == "") {
                    oldEngine = "{{ $article['id_motor'] }}";
                }
