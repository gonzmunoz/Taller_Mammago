            ...
            <form class="shop-form" method="post" enctype="multipart/form-data" action="{{ route('updateClient') }}">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6 m-b30">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <button class="site-button button-lg btn-block ml-4" type="submit">{{ trans('messages.updateUser') }}</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 m-b30" style="background: center center no-repeat url('{{ assetFtp('images/viewClient.jpg') }}'); background-size:
                        contain">
                    </div>
                </div>
            </form>
